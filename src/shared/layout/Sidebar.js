...
const Sidebar = () => {
  ...
  const canAccessFarmer = role === "farmer";
      ...
      <div className="d-flex justify-content-between align-items-center p-3 border-bottom">
        {!collapsed && (
          <div>
            ...
            <small className="text-light">Decision Intelligence System</small>
          </div>
        )}
